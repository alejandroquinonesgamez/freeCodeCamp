...
This is the Google Colaboratory project. Instructions for building your project can be found at https://www.freecodecamp.org/learn/machine-learning-with-python/machine-learning-with-python-projects/cat-and-dog-image-classifier

The solution was written by Alejandro Quiñones Gámez on "fcc_cat_dog.py" file.
